...
import { FontIssue } from '../types/audit.js';

export class FontChecker {
  private networkFontStatuses: Map<string, { status: number; statusText: string }> = new Map();
  ...
  async checkFonts(page: Page): Promise<FontIssue[]> {
