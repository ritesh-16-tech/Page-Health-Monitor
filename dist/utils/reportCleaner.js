...
export class ReportCleaner {
     ...
     */
    static async clean(outputDir = './reports', category = 'all') {
     ...
     */
    static async interactiveClean(outputDir = './reports') {
        ...
        try {
            ...
            if (result.filesDeleted === 0) {
                ...
                spinner.succeed(chalk.green(`Successfully cleaned ${chalk.bold.white(result.filesDeleted)} report file(s) — freed ${chalk.bold.white(this.formatBytes(result.bytesFreed))} of disk space!`));
            }
        }
        catch {
